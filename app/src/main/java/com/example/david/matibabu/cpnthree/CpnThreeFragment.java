...
import com.example.david.matibabu.cpnone.CpnOneFragment;
import com.example.david.matibabu.cpnone.CpnOnePresenter;
...
public class CpnThreeFragment extends Fragment {
    ...
    private Date mDate;
    CpnThreePresenter mPresenter;
    private int patientId;
    private String patientName;
    private String dateString;


    public CpnThreeFragment() {
        // Required empty public constructor
    }


    public static CpnThreeFragment newInstance() {
        return new CpnThreeFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_cpn_three,container,false);

        mPresenter = new CpnThreePresenter(getContext());
        ...
        datePicker.setOnClickListener(v ->{
            ...
            dialog.setTargetFragment(CpnThreeFragment.this,REQUEST_DATE);
